    ...
    methods (Access = public)
        function run(ctr)
            while 1
                ...
                fprintf("target2: %d\n",ctr.target2);
                fprintf("det: %d\n")
                if (ctr.target == 0 || ctr.target2 == 0) & ctr.model.dt1.Position ~= [80,0,59,100] & ctr.model.dt1.Position ~= [80,300,59,100] & ctr.model.dt1.Position ~= [80,600,59,100]
                    fprintf("1");
                    ctr.godown(1);
                end

                if (ctr.target == 0 || ctr.target2 == 0) & ctr.model.dt2.Position ~= [265,0,59,100] & ctr.model.dt2.Position ~= [265,300,59,100] & ctr.model.dt2.Position ~= [265,600,59,100]
                    fprintf("2");
                    ctr.goup(2);
                end
...
%check do not stop in the middle
        ...
        function opendoor(ctr,num,floorr)
            switch floorr
                case 1
                    if num == 1
                        ctr.buttonAPP.F1_dt1_door.Value = 1;
                        ctr.buttonAPP.F1_dt1_door.BackgroundColor = [0,1,0];
                        ctr.eleAPP.dt1_door.Value = 1;
                        ctr.model.dt1.BackgroundColor = [0,1,0];
                        ctr.eleAPP.dt1_door.BackgroundColor = [0,1,0];
                        pause(1);
                        ctr.model.dt1.BackgroundColor = [0.8,0.8,0.8];
                        ctr.buttonAPP.F1_dt1_door.Value = 0;
                        ctr.buttonAPP.F1_dt1_door.BackgroundColor = [1,1,1];
                        ctr.eleAPP.dt1_door.Value = 0;
                        ctr.eleAPP.dt1_door.BackgroundColor = [1,1,1];
                    else
                        ctr.buttonAPP.F1_dt2_door.Value = 1;
                        ctr.buttonAPP.F1_dt2_door.BackgroundColor = [0,1,0];
                        ctr.eleAPP.dt2_door.Value = 1;
                        ctr.eleAPP.dt2_door.BackgroundColor = [0,1,0];
                        ctr.model.dt2.BackgroundColor = [0,1,0];
                        pause(1);
                        ctr.model.dt2.BackgroundColor = [0.8,0.8,0.8];
                        ctr.buttonAPP.F1_dt2_door.Value = 0;
                        ctr.buttonAPP.F1_dt2_door.BackgroundColor = [1,1,1];
                        ctr.eleAPP.dt2_door.Value = 0;
                        ctr.eleAPP.dt2_door.BackgroundColor = [1,1,1];
                    end
                
                case 2
                    if num == 1
                        ctr.buttonAPP.F2_dt1_door.Value = 1;
                        ctr.buttonAPP.F2_dt1_door.BackgroundColor = [0,1,0];
                        ctr.eleAPP.dt1_door.Value = 1;
                        ctr.eleAPP.dt1_door.BackgroundColor = [0,1,0];
                        ctr.model.dt1.BackgroundColor = [0,1,0];
                        pause(1);
                        ctr.model.dt1.BackgroundColor = [0.8,0.8,0.8];
                        ctr.buttonAPP.F2_dt1_door.Value = 0;
                        ctr.buttonAPP.F2_dt1_door.BackgroundColor = [1,1,1];
                        ctr.eleAPP.dt1_door.Value = 0;
                        ctr.eleAPP.dt1_door.BackgroundColor = [1,1,1];
                    else
                        ctr.buttonAPP.F2_dt2_door.Value = 1;
                        ctr.buttonAPP.F2_dt2_door.BackgroundColor = [0,1,0];
                        ctr.eleAPP.dt2_door.Value = 1;
                        ctr.model.dt2.BackgroundColor = [0,1,0];
                        ctr.eleAPP.dt2_door.BackgroundColor = [0,1,0];
                        pause(1);
                        ctr.model.dt2.BackgroundColor = [0.8,0.8,0.8];
                        ctr.buttonAPP.F2_dt2_door.Value = 0;
                        ctr.buttonAPP.F2_dt2_door.BackgroundColor = [1,1,1];
                        ctr.eleAPP.dt2_door.Value = 0;
                        ctr.eleAPP.dt2_door.BackgroundColor = [1,1,1];
                    end
                ...
                case 3
                    if num == 1
                        ctr.buttonAPP.F3_dt1_door.Value = 1;
                        ctr.buttonAPP.F3_dt1_door.BackgroundColor = [0,1,0];
                        ctr.eleAPP.dt1_door.Value = 1;
                        ctr.eleAPP.dt1_door.BackgroundColor = [0,1,0];
                        ctr.model.dt1.BackgroundColor = [0,1,0];
                        pause(1);
                        ctr.model.dt1.BackgroundColor = [0.8,0.8,0.8];
                        ctr.buttonAPP.F3_dt1_door.Value = 0;
                        ctr.buttonAPP.F3_dt1_door.BackgroundColor = [1,1,1];
                        ctr.eleAPP.dt1_door.Value = 0;
                        ctr.eleAPP.dt1_door.BackgroundColor = [1,1,1];
                    else
                        ctr.buttonAPP.F3_dt2_door.Value = 1;
                        ctr.buttonAPP.F3_dt2_door.BackgroundColor = [0,1,0];
                        ctr.eleAPP.dt2_door.Value = 1;
                        ctr.eleAPP.dt2_door.BackgroundColor = [0,1,0];
                        ctr.model.dt2.BackgroundColor = [0,1,0];
                        pause(1);
                        ctr.model.dt2.BackgroundColor = [0.8,0.8,0.8];
                        ctr.buttonAPP.F3_dt2_door.Value = 0;
                        ctr.buttonAPP.F3_dt2_door.BackgroundColor = [1,1,1];
                        ctr.eleAPP.dt2_door.Value = 0;
                        ctr.eleAPP.dt2_door.BackgroundColor = [1,1,1];
                    end
        ...
        function updatedoornum(ctr)
                if ctr.model.dt1.Position == [80,0,59,100]
                    ctr.buttonAPP.F1_dt1_num.Value = 1;
                    ctr.buttonAPP.F2_dt1_num.Value = 1;
                    ctr.buttonAPP.F3_dt1_num.Value = 1;
                    ctr.eleAPP.dt1_num.Value = 1;
                    ctr.dt1floor = 1;
                elseif ctr.model.dt1.Position == [80,300,59,100]
                    ctr.buttonAPP.F1_dt1_num.Value = 2;
                    ctr.buttonAPP.F2_dt1_num.Value = 2;
                    ctr.buttonAPP.F3_dt1_num.Value = 2;
                    ctr.eleAPP.dt1_num.Value = 2;
                    ctr.dt1floor = 2;
                elseif ctr.model.dt1.Position == [80,600,59,100]
                    ctr.buttonAPP.F1_dt1_num.Value = 3;
                    ctr.buttonAPP.F2_dt1_num.Value = 3;
                    ctr.buttonAPP.F3_dt1_num.Value = 3;
                    ctr.eleAPP.dt1_num.Value = 3;
                    ctr.dt1floor = 3;
                end
                
                if ctr.model.dt2.Position == [265,0,59,100]
                    ctr.buttonAPP.F1_dt2_num.Value = 1;
                    ctr.buttonAPP.F2_dt2_num.Value = 1;
                    ctr.buttonAPP.F3_dt2_num.Value = 1;
                    ctr.eleAPP.dt2_num.Value = 1;
                    ctr.dt2floor = 1;
                elseif ctr.model.dt2.Position == [265,300,59,100]
                    ctr.buttonAPP.F1_dt2_num.Value = 2;
                    ctr.buttonAPP.F2_dt2_num.Value = 2;
                    ctr.buttonAPP.F3_dt2_num.Value = 2;
                    ctr.eleAPP.dt2_num.Value = 2;
                    ctr.dt2floor = 2;
                elseif ctr.model.dt2.Position == [265,600,59,100]
                    ctr.buttonAPP.F1_dt2_num.Value = 3;
                    ctr.buttonAPP.F2_dt2_num.Value = 3;
                    ctr.buttonAPP.F3_dt2_num.Value = 3;
                    ctr.eleAPP.dt2_num.Value = 3;
                    ctr.dt2floor = 3;
                end
        end
        ...
        function complete(ctr,signal)
            switch signal
                case 3
                    ...
                    ctr.F3_signal = 0;
                    ctr.buttonAPP.F3_DownButton.BackgroundColor = [0.96,0.96,0.96]; 
                case 21
                    ctr.target = ctr.target - 1;
                    ctr.F2_up_signal = 0;
                    ctr.buttonAPP.F2_UpButton.BackgroundColor = [0.96,0.96,0.96];                    
                case 22
                    ctr.target = ctr.target - 1;
                    ctr.F2_down_signal = 0;
                    ctr.buttonAPP.F2_DownButton.BackgroundColor = [0.96,0.96,0.96];
                case 1
                    ctr.target = ctr.target - 1;
                    ctr.F1_signal = 0;
                    ctr.buttonAPP.F1_UpButton.BackgroundColor = [0.96,0.96,0.96];
            end
        end
        ...
        function completeforele(ctr,signal)
            switch signal
                case 11
                    ...
                    ctr.dt1s1 = 0;
                    ctr.eleAPP.Button.BackgroundColor = [0.96,0.96,0.96];
                case 12
                    ctr.target2 = ctr.target2 - 1;
                    ctr.dt1s2 = 0;
                    ctr.eleAPP.Button_2.BackgroundColor = [0.96,0.96,0.96];
                case 13
                    ctr.target2 = ctr.target2 - 1;
                    ctr.dt1s3 = 0;
                    ctr.eleAPP.Button_3.BackgroundColor = [0.96,0.96,0.96];  
                case 21
                    ctr.target2 = ctr.target2 - 1;
                    ctr.dt2s1 = 0;
                    ctr.eleAPP.Button_4.BackgroundColor = [0.96,0.96,0.96];
                case 22
                    ctr.target2 = ctr.target2 - 1;
                    ctr.dt2s2 = 0;
                    ctr.eleAPP.Button_5.BackgroundColor = [0.96,0.96,0.96];                    
                case 23
                    ctr.target2 = ctr.target2 - 1;
                    ctr.dt2s3 = 0;
                    ctr.eleAPP.Button_6.BackgroundColor = [0.96,0.96,0.96];                    
            end
        end
